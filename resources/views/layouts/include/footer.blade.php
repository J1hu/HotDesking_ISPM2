...
<div class="container-fluid text-center text-md-left">
  ...
  <div class="row">
    ...
    <div class="col-md-6 mt-md-0 mt-3">
      ...
      <!-- Content -->
      <h5 class="text-uppercase"><b>ホットデスク Hot Desk</b></h5>
      <p>Hot Desk : A user Friendly Workspace Scheduling Software.</p>
    ...
    <div class="col-md-3 mb-md-0 mb-3">
      ...
      <!-- Links -->
      <h5 class="text-uppercase"><b>Overview</b></h5>
    ...
    <div class="col-md-3 mb-md-0 mb-3">
      ...
      <!-- Links -->
      <h5 class="text-uppercase"><b>Get Help</b></h5>
